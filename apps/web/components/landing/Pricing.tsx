...
const FAQ = [
  ...
  {
    q: "When will Pro and Studio be available?",
    a: "We are actively building the payment infrastructure for our premium tiers. They will be available very soon!",
  },
];
            ...
            return (
              ...
              >
                ...
                {!plan.popular && plan.comingSoon && (
                  <div className="absolute right-6 top-6 rounded-full border border-black/10 bg-slate-100 px-3 py-1 text-xs font-bold text-slate-500 dark:border-white/10 dark:bg-white/10 dark:text-white/60">
                    Coming Soon
                  </div>
                )}
                ...
                <div className="relative z-10">
                  ...
                  {ctaDisabled ? (
                    <button
                      disabled
                      className={`mt-8 w-full rounded-2xl px-5 py-3.5 text-sm font-bold opacity-70 cursor-not-allowed ${
                        plan.popular
                          ? "bg-slate-800 text-white/50 dark:bg-white/10 dark:text-white/40"
                          : "bg-slate-100 text-slate-400 dark:bg-white/[0.03] dark:text-white/30"
                      }`}
                    >
                      {ctaText}
                    </button>
